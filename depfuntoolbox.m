...
%
% Note: Due to bugs in depfun that can cause a large number of incorrect
% dependencies to be listed, I no longer use this function.  But it might
% still be useful if your depfun works properly.
%
% Input variables:
%
